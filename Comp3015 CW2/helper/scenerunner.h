...
private:
    ...
    void mainLoop(GLFWwindow* window, Scene& scene) {
        while (!glfwWindowShouldClose(window) && !glfwGetKey(window, GLFW_KEY_ESCAPE)) {
            ...
            scene.keyInput(GLFW_KEY_W, glfwGetKey(window, GLFW_KEY_W));
            scene.keyInput(GLFW_KEY_A, glfwGetKey(window, GLFW_KEY_A));
            scene.keyInput(GLFW_KEY_S, glfwGetKey(window, GLFW_KEY_S));
            scene.keyInput(GLFW_KEY_D, glfwGetKey(window, GLFW_KEY_D));
            scene.keyInput(GLFW_KEY_Q, glfwGetKey(window, GLFW_KEY_Q));
